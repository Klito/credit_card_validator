...
def validate_card(card_number):
    ...
    card_number_list = [int(s) for s in card_number]
...
def check_valid_card(card_number, card_cvv):
    return (validate_card(card_number) and check_cvv(card_cvv, check_issuer(card_number)))


# https://generator-credit-card.com/
print(check_issuer("4024007175662062"))
print(check_valid_card("4024007175662062","045"))